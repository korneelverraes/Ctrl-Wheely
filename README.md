...
In de definitiefase verdiepen we ons in het probleem, met fascinatie voor het probleem en niet voor onze eigen oplossing maken we eerste prototypes en trekken we al snel naar de eerste gebruikers. Met hun feedback passen we aan en gaan we verder. Dat is zowat de hoofdstrategie van ons ontwerpproces. Via een storytelling en de gebruikerstesten krijgen we meer inzicht in de gebruiker. Wat zijn de noden van onze gebruikers en hoe vertaalt dat zich in onze oplossing. Na elke test en elk onderzoek stellen we de nodige design requirements op. Ook design requirements opgesteld in het begin van het project blijven van tel doorheen het hele proces.
...
Omwille van deze redenen hebben we besloten de scores van de risicoperceptietest te verwerpen. De resultaten zijn afhankelijk van externe factoren en dus geen goede maatstaaf om de afleiding op die manier te kwantificeren. De risicoperceptietest werd ook vastgelged op beeld. Aan de hand van deze beelden zouden we alle handelingen kunnen timen. Hoe minder lang de bediening duurt, hoe minder afleiding. Wegens tijdgebrek hebben we dit echter niet kunnen doen, al gaven de testpersonen zelf meermaals aan dat ze meer afgeleid waren tijdens de bediening van het touchscreen.
