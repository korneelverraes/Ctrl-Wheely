    ...
    if (encoderState != encoderLastState) {
      if (digitalRead(encoderBPin) != encoderState) {
        ...
        if (direction == 0 && lastDirection == 0) {
          ...
          direction = 1; //dit is echt shitty code, om 3 klikjes te negeren: begin helemaal opnieuw
        }
        ...
        if (direction == 1 && lastDirection == 1) {
          ...
          direction = 0; //dit is echt shitty code, om 3 klikjes te negeren: begin helemaal opnieuw
        }
        lastDirection = direction;
      }
    }
